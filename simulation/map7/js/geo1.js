...
$(function()
{
	...
	$('#select8-1').on('change', function() {
		$(this).next("span").remove();
		m=$(this).val();
		if(solidline == 0 && m ==1300)
			$(this).prop('disabled',true);
		else if(solidline == 1 && m == 1400)
			$(this).prop('disabled',true);
		else if(solidline == 2 && m == 1500)
			$(this).prop('disabled',true);
		else if(solidline == 3 && m == 1600)
			$(this).prop('disabled',true);
		else if(solidline == 4 && m == 1500)
			$(this).prop('disabled',true);
		else if(solidline == 5 && m == 1400)
			$(this).prop('disabled',true);
		else if(solidline == 6 && m == 1300)
			$(this).prop('disabled',true);
		else if(solidline == 7 && m == 1400)
			$(this).prop('disabled',true);
		else if(solidline == 8 && m == 1500)
			$(this).prop('disabled',true);
		else
	...
	$('#select8-2').on('change', function() {
		$(this).next("span").remove();
		n=$(this).val();
		if(solidline == 0 && n == 1400)
			$(this).prop('disabled',true);
		else if(solidline == 1 && n == 1500)
			$(this).prop('disabled',true);
		else if(solidline == 2 && n == 1600)
			$(this).prop('disabled',true);
		else if(solidline == 3 && n == 1500)
			$(this).prop('disabled',true);
		else if(solidline == 4 && n == 1400)
			$(this).prop('disabled',true);
		else if(solidline == 5 && n == 1300)
			$(this).prop('disabled',true);
		else if(solidline == 6 && n == 1400)
			$(this).prop('disabled',true);
		else if(solidline == 7 && n == 1500)
			$(this).prop('disabled',true);
		else if(solidline == 8 && n == 1600)
			$(this).prop('disabled',true);
		else
	...
	$('#calci').click(function()
	{
		...
		if( solidline == 0 )
		{
			printCalculation(solidline,"&alpha;=30","&beta;=140","&yen;=50","<strong>&alpha;<&beta;</strong>","Index=(N*(¥- α )+M*( β-¥))/( β- α)","Index=(1400*(50-30)+1300*(140-50))/(140-30)",solidpoints[solidline][1]);
		}
		else if( solidline == 1 )
		{			
			printCalculation(solidline,"&alpha;=140","&beta;=290","&yen;=190","<strong>&alpha;<&beta;</strong>","Index=(N*(¥- α )+M*( β-¥))/( β- α)","Index=(1500*(190-140)+1400*(290-190))/(290-140)",solidpoints[solidline][1]);
		}
		else if( solidline == 2 )
		{
			printCalculation(solidline,"&alpha;=290","&beta;=450","&yen;=360","<strong>&alpha;<&beta;</strong>","Index=(N*(¥- α )+M*( β-¥))/( β- α)","Index=(1600*(360-290)+1500*(450-360))/(450-290)",solidpoints[solidline][1]);
		}
		else if( solidline == 3 )
		{
			printCalculation(solidline,"&alpha;=550","&beta;=690","&yen;=650","<strong>&alpha;<&beta;</strong>","Index=(N*(¥- α )+M*( β-¥))/( β- α)","Index=(1500*(650-550)+1600*(690-650))/(690-550)",solidpoints[solidline][1]);
		}
		else if( solidline == 4 )
		{
			printCalculation(solidline,"&alpha;=690","&beta;=840","&yen;=810","<strong>&alpha;<&beta;</strong>","Index=(N*(¥- α )+M*( β-¥))/( β- α)","Index=(1400*(810-690)+1500*(840-810))/(840-690)",solidpoints[solidline][1]);
		}
		else if( solidline == 5)
		{
			printCalculation(solidline,"&alpha;=840","&beta;=960","&yen;=940","<strong>&alpha;<&beta;</strong>","Index=(N*(¥- α )+M*( β-¥))/( β- α)","Index=(1300*(940-840)+1400*(960-940))/(960-840)",solidpoints[solidline][1]);
		}
		else if( solidline == 6 )
		{
			printCalculation(solidline,"&alpha;=1050","&beta;=1190","&yen;=1095","<strong>&alpha;<&beta;</strong>","Index=(N*(¥- α )+M*( β-¥))/( β- α)","Index=(1400*(1095-1050)+1300*(1190-1095))/(1190-1050)",solidpoints[solidline][1]);
		}
		else if( solidline == 7 )
		{
			printCalculation(solidline,"&alpha;=1190","&beta;=1380","&yen;=1250","<strong>&alpha;<&beta;</strong>","Index=(N*(¥- α )+M*( β-¥))/( β- α)","Index=(1500*(1250-1190)+1400*(1380-1250))/(1380-1190)",solidpoints[solidline][1]);
		}
		else if( solidline == 8 )
		{
			printCalculation(solidline,"&alpha;=1380","&beta;=1535","&yen;=1410","<strong>&alpha;<&beta;</strong>","Index=(N*(¥- α )+M*( β-¥))/( β- α)","Index=(1600*(1410-1380)+1500*(1535-1410))/(1535-1380)",solidpoints[solidline][1]);
		}
	});
	$('#nb').click(function()
	{ 	
	...
	$('#dottable td').on('click',function()
	{
		...
		switch(rowid)
		{
			case 'a1' : ctx.arc(grid_size*(dotpoints[0][0]/100), -grid_size*(dotpoints[0][1]-1000)/100,3,0,2*Math.PI,false);
						ctx.stroke();	
						ctx.fill();	
						ctx.closePath();
						$('#a1').off('click');
						...
						a1=1;
						break;
			case 'b1' :	ctx.arc(grid_size*(dotpoints[1][0]/100), -grid_size*(dotpoints[1][1]-1000)/100,3,0,2*Math.PI,false);
						ctx.stroke();	
						ctx.fill();		
						ctx.closePath();
						$('#b1').off('click');
			...
			case 'c1' :	ctx.arc(grid_size*(dotpoints[2][0]/100), -grid_size*(dotpoints[2][1]-1000)/100,3,0,2*Math.PI,false);
						ctx.stroke();	
						ctx.fill();	
						ctx.closePath();
						$('#c1').off('click');
			...
			case 'd1' :	
						ctx.arc(grid_size*(dotpoints[3][0]/100), -grid_size*(dotpoints[3][1]-1000)/100,3,0,2*Math.PI,false);
						ctx.stroke();	
						ctx.fill();		
						ctx.closePath();
						$('#d1').off('click');
			...
			case 'e1' :	ctx.arc(grid_size*(dotpoints[4][0]/100), -grid_size*(dotpoints[4][1]-1000)/100,3,0,2*Math.PI,false);
						ctx.stroke();	
						ctx.fill();		
						ctx.closePath();
						$('#e1').off('click');
			...
			case 'f1' :	ctx.arc(grid_size*(dotpoints[5][0]/100), -grid_size*(dotpoints[5][1]-1000)/100,3,0,2*Math.PI,false);
						ctx.stroke();	
						ctx.fill();		
						ctx.closePath();
						$('#f1').off('click');
			...
			case 'g1' :	ctx.arc(grid_size*(dotpoints[6][0]/100), -grid_size*(dotpoints[6][1]-1000)/100,3,0,2*Math.PI,false);
						ctx.stroke();	
						ctx.fill();		
						ctx.closePath();
						$('#g1').off('click');
			...
			case 'h1' :	ctx.arc(grid_size*(dotpoints[7][0]/100), -grid_size*(dotpoints[7][1]-1000)/100,3,0,2*Math.PI,false);
						ctx.stroke();	
						ctx.fill();		
						ctx.closePath();
						$('#h1').off('click');
			...
			case 'i1' :	ctx.arc(grid_size*(dotpoints[8][0]/100), -grid_size*(dotpoints[8][1]-1000)/100,3,0,2*Math.PI,false);
						ctx.stroke();	
						ctx.fill();		
						ctx.closePath();
						$('#i1').off('click');
						...
						break;
			case 'j1' :	ctx.arc(grid_size*(dotpoints[9][0]/100), -grid_size*(dotpoints[9][1]-1000)/100,3,0,2*Math.PI,false);
						ctx.stroke();	
						ctx.fill();		
						ctx.closePath();
						$('#j1').off('click');
			...
			case 'k1' :	ctx.arc(grid_size*(dotpoints[10][0]/100), -grid_size*(dotpoints[10][1]-1000)/100,3,0,2*Math.PI,false);
						ctx.stroke();	
						ctx.fill();		
						ctx.closePath();
						$('#k1').off('click');
		...
		if(a1 == 1 && b1 == 1 && c1 == 1 && d1 == 1 && e1 == 1 && f1 == 1 && g1 == 1 && h1 == 1 && i1 == 1 && j1 == 1 && k1 == 1)
		{
	...
	$('#solidtable td').on('click',function()
	{
		...
		switch(rowidd)
		{
			case 'p' : 	ctx.arc(grid_size*(solidpoints[0][0]/100), -grid_size*((solidpoints[0][1]-1000)/100),3,0,2*Math.PI,false);
						ctx.stroke();	
						ctx.fill();	
						ctx.closePath();
						$('#p').off('click');
						...
						p=1;
						break;
			case 'q' :	ctx.arc(grid_size*(solidpoints[1][0]/100), -grid_size*((solidpoints[1][1]-1000)/100),3,0,2*Math.PI,false);
						ctx.stroke();	
						ctx.fill();		
						ctx.closePath();
						$('#q').off('click');
			...
			case 'r' :	ctx.arc(grid_size*(solidpoints[2][0]/100), -grid_size*((solidpoints[2][1]-1000)/100),3,0,2*Math.PI,false);
						ctx.stroke();	
						ctx.fill();	
						ctx.closePath();
						$('#r').off('click');
			...
			case 's' :	
						ctx.arc(grid_size*(solidpoints[3][0]/100), -grid_size*((solidpoints[3][1]-1000)/100),3,0,2*Math.PI,false);
						ctx.stroke();	
						ctx.fill();		
						ctx.closePath();
						$('#s').off('click');
			...
			case 't' :	ctx.arc(grid_size*(solidpoints[4][0]/100), -grid_size*((solidpoints[4][1]-1000)/100),3,0,2*Math.PI,false);
						ctx.stroke();	
						ctx.fill();		
						ctx.closePath();
						$('#t').off('click');
			...
			case 'u' :	ctx.arc(grid_size*(solidpoints[5][0]/100), -grid_size*((solidpoints[5][1]-1000)/100),3,0,2*Math.PI,false);
						ctx.stroke();	
						ctx.fill();		
						ctx.closePath();
						$('#u').off('click');
						...
						u=1;
						break;
			case 'v' :	ctx.arc(grid_size*(solidpoints[6][0]/100), -grid_size*((solidpoints[6][1]-1000)/100),3,0,2*Math.PI,false);
						ctx.stroke();	
						ctx.fill();		
						ctx.closePath();
						$('#v').off('click');
						...
						v=1;
						break;
			case 'w' :	ctx.arc(grid_size*(solidpoints[7][0]/100), -grid_size*((solidpoints[7][1]-1000)/100),3,0,2*Math.PI,false);
						ctx.stroke();	
						ctx.fill();		
						ctx.closePath();
						$('#w').off('click');
						...
						w=1;
						break;
			case 'x' :	ctx.arc(grid_size*(solidpoints[8][0]/100), -grid_size*((solidpoints[8][1]-1000)/100),3,0,2*Math.PI,false);
						ctx.stroke();	
						ctx.fill();		
						ctx.closePath();
						$('#x').off('click');
		...
		if(p == 1 && q == 1 && r == 1 && s == 1 && t == 1 && u == 1 && v == 1 && w == 1 && x == 1)
		{
...
function magic()
{
	...
	else if(simsubscreennum == 11)
	{
		...
		setTimeout(function()
		{
			document.getElementById('can12-1').innerHTML="&#10148;Angle of Dip calculated as:";
 ...
 function toDrawDrip(elem)
{
		...
		if(dripid == "pp")
		{
			if(drip == 0)
			{
				setText("p",grid_size*(p1.x-15)/100,grid_size*(p1.y-20)/100);
				letter = "p'";
				gameLoop();
			}
		}
		else if(dripid == "qq")
		{
			if(drip==1)
			{
				...
				setText("q",grid_size*(p1.x-15)/100,grid_size*(p1.y-20)/100);
				letter = "q'";				
				gameLoop();
			}
		}
		else if(dripid == "rr")
		{
			if(drip==2)
			{
				...
				xunits = Math.cos(radians)*speed;
				yunits = Math.sin(radians)*speed;
				setText("r",grid_size*(p1.x-15)/100,grid_size*(p1.y-20)/100);
				letter = "r'";	
				gameLoop();
			}
		}
		else if(dripid == "ss")
		{
			if(drip==3)
			{
				...
				xunits = Math.cos(radians)*speed;
				yunits = Math.sin(radians)*speed;
				setText("s",grid_size*(p1.x-15)/100,grid_size*(p1.y-20)/100);
				letter = "s'";	
				gameLoop();
			}
		}
		else if(dripid == "ttt")
		{
			if(drip==4)
			{
				...
				xunits = Math.cos(radians)*speed;
				yunits = Math.sin(radians)*speed;
				setText("t",grid_size*(p1.x-15)/100,grid_size*(p1.y-20)/100);
				letter = "t'";	
				gameLoop();
			}
		}
		else if(dripid == "uu")
		{
			if(drip==5)
			{
				...
				xunits = Math.cos(radians)*speed;
				yunits = Math.sin(radians)*speed;
				setText("u",grid_size*(p1.x-15)/100,grid_size*(p1.y-20)/100);
				letter = "u'";	
				gameLoop();
			}
		}
		else if(dripid == "vv")
		{
			if(drip==6)
			{
				...
				xunits = Math.cos(radians)*speed;
				yunits = Math.sin(radians)*speed;
				setText("v",grid_size*(p1.x-15)/100,grid_size*(p1.y-20)/100);
				letter = "v'";	
				gameLoop();
			}
		}
		else if(dripid == "ww")
		{
			if(drip==7)
			{
				...
				xunits = Math.cos(radians)*speed;
				yunits = Math.sin(radians)*speed;
				setText("w",grid_size*(p1.x-15)/100,grid_size*(p1.y-20)/100);
				letter = "w'";	
				gameLoop();
			}
		}
		else if(dripid == "xx")
		{
			if(drip==8)
			{
				...
				xunits = Math.cos(radians)*speed;
				yunits = Math.sin(radians)*speed;
				setText("x",grid_size*(p1.x-15)/100,grid_size*(p1.y-20)/100);
				letter = "x'";	
				gameLoop();
			}
		}
		else if(dripid == "oo")
		{
			if(drip==9)
			{
				...
				xunits = Math.cos(radians)*speed;
				yunits = Math.sin(radians)*speed;
				setText("o",grid_size*(p1.x-15)/100,grid_size*(p1.y-20)/100);
				letter = "o'";	
				gameLoop();
			}
		}
		else if(dripid == "mm")
		{
			if(drip==10)
			{
				...
				xunits = Math.cos(radians)*speed;
				yunits = Math.sin(radians)*speed;
				setText("m",grid_size*(p1.x-15)/100,grid_size*(p1.y-20)/100);
				letter = "m'";	
				gameLoop();
			}
		}
		else if(dripid == "nn")
		{
			if(drip==11)
			{
				...
				xunits = Math.cos(radians)*speed;
				yunits = Math.sin(radians)*speed;
				setText("n",grid_size*(p1.x-15)/100,grid_size*(p1.y-20)/100);
				letter = "n'";	
				gameLoop();
			}
		}
...
function drawScreen()
{
	...
	if(grid_size*ball.y/100>-stopPoint)
	{
		...
		if(drip == 3)
		{
			...
			ctx.quadraticCurveTo(grid_size*(ball.x-54)/100,grid_size*(ball.y+26)/100,grid_size*(ball.x-158)/100,grid_size*ball.y/100);			
			ctx.stroke();
		}
		if(drip == 4)
		{
			ctx.beginPath();
			ctx.moveTo(grid_size*ball.x/100,grid_size*ball.y/100);
			ctx.quadraticCurveTo(grid_size*(ball.x-50)/100,grid_size*(ball.y+25)/100,grid_size*(ball.x-148)/100,grid_size*ball.y/100);			
			ctx.stroke();
		}
		if(drip == 5)
		{
			ctx.beginPath();
			ctx.moveTo(grid_size*ball.x/100,grid_size*ball.y/100);
			ctx.quadraticCurveTo(grid_size*(ball.x-125)/100,grid_size*(ball.y+40)/100,grid_size*(ball.x-280)/100,grid_size*ball.y/100);			
			ctx.stroke();
		}
		if(drip == 9)
		{
		...
		if(drip == 11)
		{
			...
			ctx.quadraticCurveTo(grid_size*(nx-125)/100,grid_size*(ny-80)/100,grid_size*(nx-204)/100,grid_size*ny/100);			
			ctx.stroke();
			document.getElementById("nextButton").style.visibility = "visible";
		}
		drip++;
...
function drawLimePatterns()
{
	...
	ctx.fillText("+",grid_size*1500/100,-grid_size*(1470-1000)/100);
	i=1420;j=1510;
	while(i<=1500)
	{
		ctx.fillText("+",grid_size*i/100,-grid_size*(j-1000)/100);
	...
	ctx.fillText("+",grid_size*1510/100,-grid_size*(1550-1000)/100);
}
...
function drawShalePatterns()
{
	...
	ctx.font="12px Verdana";
	ctx.lineWidth=2;
	i=320;j=1500,stopPoint = 400;
	fillTextPatterns("\u2729",i,j,stopPoint);
	i=270;j=1460,stopPoint = 700;
	fillTextPatterns("\u2729",i,j,stopPoint);
	i=220;j=1420,stopPoint = 760;
	fillTextPatterns("\u2729",i,j,stopPoint);
	i=280;j=1380,stopPoint = 720;
	fillTextPatterns("\u2729",i,j,stopPoint);
	i=350;j=1340,stopPoint = 660;
	fillTextPatterns("\u2729",i,j,stopPoint);
	i=410;j=1300,stopPoint = 550;
	fillTextPatterns("\u2729",i,j,stopPoint);
	i=1380;j=1480,stopPoint =1450;
	fillTextPatterns("\u2729",i,j,stopPoint);
	i=1320;j=1440,stopPoint =1480;
	fillTextPatterns("\u2729",i,j,stopPoint);
	i=1280;j=1400,stopPoint =1520;
	fillTextPatterns("\u2729",i,j,stopPoint);
	i=1360;j=1360,stopPoint =1520;
	fillTextPatterns("\u2729",i,j,stopPoint);
	i=1420;j=1320,stopPoint =1500;
	fillTextPatterns("\u2729",i,j,stopPoint);
	i=1500;j=1280,stopPoint =1520;
	fillTextPatterns("\u2729",i,j,stopPoint);
	ctx.closePath();
}
...
function drawRedPatterns()
{
	...
	ctx.font="12px Verdana";
	ctx.lineWidth=2;
	i=180;j=1400,stopPoint = 200;
	fillTextPatterns("\u25B2",i,j,stopPoint);
	i=120;j=1360,stopPoint = 250;
	fillTextPatterns("\u25B2",i,j,stopPoint);
	i=80;j=1320,stopPoint = 350;
	fillTextPatterns("\u25B2",i,j,stopPoint);
	i=120;j=1280,stopPoint = 400;
	fillTextPatterns("\u25B2",i,j,stopPoint);
	i=200;j=1240,stopPoint = 780;
	fillTextPatterns("\u25B2",i,j,stopPoint);
	i=240;j=1200,stopPoint = 750;
	fillTextPatterns("\u25B2",i,j,stopPoint);
	i=260;j=1160,stopPoint = 700;
	fillTextPatterns("\u25B2",i,j,stopPoint);
	i=350;j=1120,stopPoint = 600;
	fillTextPatterns("\u25B2",i,j,stopPoint);
	i=420;j=1080,stopPoint = 580;
	fillTextPatterns("\u25B2",i,j,stopPoint);
	i=620;j=1280,stopPoint = 900;
	fillTextPatterns("\u25B2",i,j,stopPoint);
	i=650;j=1320,stopPoint = 900;
	fillTextPatterns("\u25B2",i,j,stopPoint);
	i=730;j=1360,stopPoint = 850;
	fillTextPatterns("\u25B2",i,j,stopPoint);
	i=1250;j=1400,stopPoint = 1250;
	fillTextPatterns("\u25B2",i,j,stopPoint);
	i=1170;j=1360,stopPoint = 1350;
	fillTextPatterns("\u25B2",i,j,stopPoint);
	i=1150;j=1320,stopPoint = 1380;
	fillTextPatterns("\u25B2",i,j,stopPoint);
	i=1180;j=1280,stopPoint = 1460;
	fillTextPatterns("\u25B2",i,j,stopPoint);
	i=1260;j=1240,stopPoint = 1490;
	fillTextPatterns("\u25B2",i,j,stopPoint);
	i=1320;j=1200,stopPoint = 1490;
	fillTextPatterns("\u25B2",i,j,stopPoint);
	i=1380;j=1160,stopPoint = 1500;
	fillTextPatterns("\u25B2",i,j,stopPoint);
	i=1410;j=1120,stopPoint = 1500;
	fillTextPatterns("\u25B2",i,j,stopPoint);
	i=1480;j=1080,stopPoint = 1500;
	fillTextPatterns("\u25B2",i,j,stopPoint);
}
...
function drawSandPatterns()
{
	...
	ctx.font="12px Verdana";
	ctx.lineWidth=2;
	i=20;j=1260,stopPoint = 100;
	fillTextPatterns("\u25B0",i,j,stopPoint);
	i=20;j=1220,stopPoint = 150;
	fillTextPatterns("\u25B0",i,j,stopPoint);
	i=50;j=1160,stopPoint = 200;
	fillTextPatterns("\u25B0",i,j,stopPoint);
	i=80;j=1120,stopPoint = 230;
	fillTextPatterns("\u25B0",i,j,stopPoint);
	i=110;j=1080,stopPoint = 350;
	fillTextPatterns("\u25B0",i,j,stopPoint);
	i=150;j=1040,stopPoint = 850;
	fillTextPatterns("\u25B0",i,j,stopPoint);
	i=250;j=1000,stopPoint = 810;
	fillTextPatterns("\u25B0",i,j,stopPoint);
	i=650;j=1040,stopPoint = 880;
	fillTextPatterns("\u25B0",i,j,stopPoint);
	i=640;j=1080,stopPoint = 920;
	fillTextPatterns("\u25B0",i,j,stopPoint);
	i=700;j=1120,stopPoint = 950;
	fillTextPatterns("\u25B0",i,j,stopPoint);
	i=730;j=1160,stopPoint = 1300;
	fillTextPatterns("\u25B0",i,j,stopPoint);
	i=1100;j=1120,stopPoint = 1350;
	fillTextPatterns("\u25B0",i,j,stopPoint);
	i=1180;j=1080,stopPoint = 1420;
	fillTextPatterns("\u25B0",i,j,stopPoint);
	i=1200;j=1040,stopPoint = 1450;
	fillTextPatterns("\u25B0",i,j,stopPoint);
	i=1250;j=1000,stopPoint = 1500;
	fillTextPatterns("\u25B0",i,j,stopPoint);
	i=850;j=1210,stopPoint = 1200;
	fillTextPatterns("\u25B0",i,j,stopPoint);
	i=880;j=1250,stopPoint = 1150;
	fillTextPatterns("\u25B0",i,j,stopPoint);
	i=920;j=1290,stopPoint = 920;
	fillTextPatterns("\u25B0",i,j,stopPoint);
	i=1100;j=1290,stopPoint = 1100;
	fillTextPatterns("\u25B0",i,j,stopPoint);
	ctx.closePath();
}
...
function drawCongoPatterns()
{
	...
	ctx.font="12px Verdana";
	ctx.lineWidth=2;
	i=5;j=1120,stopPoint = 20;
	fillTextPatterns("\u25C9",i,j,stopPoint);
	i=5;j=1080,stopPoint = 80;
	fillTextPatterns("\u25C9",i,j,stopPoint);
	i=5;j=1040,stopPoint = 120;
	fillTextPatterns("\u25C9",i,j,stopPoint);
	i=5;j=1000,stopPoint = 200;
	fillTextPatterns("\u25C9",i,j,stopPoint);
	i=940;j=1080,stopPoint = 1100;
	fillTextPatterns("\u25C9",i,j,stopPoint);
	i=890;j=1040,stopPoint = 1150;
	fillTextPatterns("\u25C9",i,j,stopPoint);
	i=860;j=1000,stopPoint = 1220;
	fillTextPatterns("\u25C9",i,j,stopPoint);
	i=1030;j=1110,stopPoint = 1030;
	fillTextPatterns("\u25C9",i,j,stopPoint);
...
function fillTextPatterns(pattern,xcoord,ycoord,stopPoint)
{
	while(i<=stopPoint)
	{
		ctx.fillText(pattern,grid_size*i/100,-grid_size*(j-1000)/100);
		i=i+50;
	}	
}
...
function tickYaxis()
{
	...
	for(i=1; i<(num_lines_y); i++) {
		...
		ctx.font = '10px Verdana';
		ctx.textAlign = 'start';
		ctx.fillText(xaxis_starting_point.number*i+1000 + xaxis_starting_point.suffix, -30,-grid_size*i);
		ctx.stroke();
		ctx.closePath();
	}
...
function joinPoints()
{
	...
	ctx.lineWidth=1;
		if(jpts==4)
		{
			ctx.quadraticCurveTo(grid_size*((dotpoints[jpts][0]/100)-0.35),-grid_size*((dotpoints[jpts][1]-1000)/100+0.35),grid_size*(dotpoints[jpts][0]/100),-grid_size*((dotpoints[jpts][1]-1000)/100));
		}
		if(jpts==8)
		{
			ctx.quadraticCurveTo(grid_size*((dotpoints[jpts][0]/100)-0.35),-grid_size*((dotpoints[jpts][1]-1000)/100-0.35),grid_size*(dotpoints[jpts][0]/100),-grid_size*((dotpoints[jpts][1]-1000)/100));
		}
		if(jpts == 0 || jpts == 1 || jpts == 2 || jpts == 3 || jpts == 5 || jpts == 6 || jpts == 7 || jpts == 9 || jpts == 10)
		{	
			jpoints(grid_size*(dotpoints[jpts][0]/100),-grid_size*(dotpoints[jpts][1]-1000)/100);
		}
	jpts++;
}
...
function chkdrip2()
{
	...
	else if(drip == 5)
	{
		...
		generateQuestion(q1,"Identify the region with this pattern <span style = 'color:blue'>\u2729 \u2729 \u2729</span> ","","Conglomerate","Shale","Redstone","Banded Shale",2,nextButtonProceed,100,150,300,120);
	}
 ...
 function resetTable(tval)
 {
	...
	else if(solidline == 8)
	{
		setTimeout(function()
		{
			...
			document.getElementById('p9').style="color:black;background-color:white";		
 ...
 function setColorTable(sline)
 {
	 ...
	 {
		document.getElementById("p"+(sline+1)).style="color:white;background-color:blue";
		document.getElementById("mn"+(sline+2)).style="color:white;background-color:red";
		document.getElementById("mn"+(sline+3)).style="color:white;background-color:green";
	 }
	 else if(sline == 6 || sline == 7 || sline == 8)
	 {
		document.getElementById("p"+(sline+1)).style="color:white;background-color:blue";
		document.getElementById("mn"+(sline+3)).style="color:white;background-color:red";
		document.getElementById("mn"+(sline+4)).style="color:white;background-color:green";
	 }
 }
 function removeColorTable(sline)
 {
	 ...
	 else if(sline == 6 || sline == 7 || sline == 8)
	 {
		document.getElementById("p"+(sline)).style="color:black;background-color:white";
		document.getElementById("mn"+(sline+1)).style="color:black;background-color:white";
		document.getElementById("mn"+(sline+2)).style="color:black;background-color:white";
	 }
 }
 ...
 function horizontalLine(fromX,toX,toY,arcrad)
 {
	...
	ctx.strokeStyle = "black";
	ctx.fillStyle = "blue";
	ctx.arc(grid_size*((fromX+50)/100),-grid_size*((toY-1000)/100),arcrad,0,0.8*Math.PI,false);
	ctx.fillText("\u03B8",grid_size*((fromX+60)/100),-grid_size*((toY-1050)/100));
	ctx.stroke();	
	setTimeout(function(){
		setDialog("Draw a vertical line between the upper and lower contact in a non horizontal unit.",100,185,120,250);
	},800);
 }
 function verticalLine(fromX,fromY,toY)
 {
	...
	ctx.moveTo(grid_size*(fromX/100),-(grid_size*((fromY-1000)/100)));
	ctx.lineTo(grid_size*((fromX+50)/100),-(grid_size*((fromY-1000)/100)));
	ctx.moveTo(grid_size*(fromX/100),-(grid_size*((toY-1000)/100)));
	ctx.lineTo(grid_size*((fromX+50)/100),-(grid_size*((toY-1000)/100)));
	ctx.moveTo(grid_size*((fromX+30)/100),-(grid_size*((fromY-1000)/100)));
	ctx.lineTo(grid_size*((fromX+30)/100),-(grid_size*((toY-1000)/100)));
	ctx.fillText("VT",grid_size*((fromX+50)/100),-(grid_size*((toY-950)/100)));
	ctx.stroke();
	setTimeout(function(){
		setDialog("Draw a perpendicular line from intersecting point.",100,185,100,250);
	},800);
 }
 function perpendicularLine(fX,fY,tX,tY)
 {
	...
	ctx.fillText("TT",grid_size*((fX+10)/100),-(grid_size*((fY-1058)/100)));
	// ctx.stroke();
	ctx.closePath();
	...
	if(screensVal == 3){
		setTimeout(function(){
			setDialog("Determine vertical and true thickness for shale region.",100,185,100,250);
		},800);
	}else if(screensVal == 4){
		setTimeout(function(){
			setDialog("Determine vertical and true thickness for Sandstone region.",100,185,100,250);
		},800);
	}
 }
 function hvp(f1,t1,f2,t2,sf1,st1,sf2,st2)
 {
	...
	ctx.fillText("VT",grid_size*((f1-80)/100),-(grid_size*((t1-1150)/100)));
	ctx.stroke();
    ...
    ctx.fillStyle="blue";
	ctx.font="14px"
	ctx.fillText("TT",grid_size*((sf1+150)/100),-(grid_size*((st1-950)/100)));
	ctx.stroke();
	ctx.closePath();
...
function hideDialog()
{
	...
	if(simsubscreennum == 15 && screensVal == 0){
		...
		ctx.arc(grid_size*((sX+50)/100),-grid_size*((sY-1000)/100),arcrad,0,0.8*Math.PI,false);
		ctx.fillText("\u03B8",grid_size*((sX+60)/100),-grid_size*((sY-1050)/100));
		ctx.stroke();
		ctx.closePath();
		ctx.beginPath();
		ctx.moveTo(grid_size*(sX/100),-(grid_size*((sY-1000)/100)));
		hInt=setInterval(function(){drawHorizontalLineAnimation();},10);
		...
		ctx.beginPath();
		ctx.moveTo(grid_size*(sX/100),-(grid_size*((sY-1000)/100)));
		hInt=setInterval(function(){drawVerticalLineAnimation();},10);
		...
		ctx.beginPath();
		ctx.moveTo(grid_size*(sX/100),-(grid_size*((sY-1000)/100)));
		hInt=setInterval(function(){drawPerpendicularLineAnimation();},10);
...
function drawVerticalLineAnimation()
{
	...
	if (sY==dY) 
	{
		...
		if(vCount == 0)
		{
			...
			ctx.lineTo(grid_size*((sX+50)/100),-(grid_size*((tempY-1000)/100)));
			ctx.moveTo(grid_size*(sX/100),-(grid_size*((dY-1000)/100)));
			ctx.lineTo(grid_size*((sX+50)/100),-(grid_size*((dY-1000)/100)));
			ctx.moveTo(grid_size*((sX+30)/100),-(grid_size*((tempY-1000)/100)));
			ctx.lineTo(grid_size*((sX+30)/100),-(grid_size*((dY-1000)/100)));
			ctx.fillText("VT",grid_size*((sX+50)/100),-(grid_size*((dY-950)/100)));
			ctx.stroke();
			setDialog("Draw a perpendicular line from intersecting point.",100,185,100,250);
		}
		else if(vCount == 1)
		...
		else if(vCount == 2)
		{
			...
			ctx.moveTo(grid_size*((sX-30)/100),-(grid_size*((tempY-1000)/100)));
			ctx.lineTo(grid_size*((sX-30)/100),-(grid_size*((dY-1000)/100)));
			ctx.fillText("VT",grid_size*((sX-100)/100),-(grid_size*((dY-950)/100)));
			ctx.stroke();
			sX = 1220;
			sY = 1250;
			dX = 1095;
...
function drawPerpendicularLineAnimation()
{
	...
	if(sX == dX) 
	{
		...
		if(pCount == 0)
		{
			...
			ctx.fillText("TT",grid_size*((tempX+10)/100),-(grid_size*((tempY-1058)/100)));
			ctx.closePath();
			for(k=0;k<=2;k++)
			{
				var cell = row.insertCell();
		...
		var q1 = Object.create(questions);												
		generateQuestion(q1,"True Thickness of Shale region is ______: ","","150m","170m","220m","180m",4,nextButtonProceed,100,150,300,120);		}
	}
}
